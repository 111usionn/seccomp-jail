...
Q_QMLTYPE_EXPORT void qml_register_types_FluentUI()
{
    ...
    {
        Q_CONSTINIT static auto metaType = QQmlPrivate::metaTypeForNamespace(
            [](const QtPrivate::QMetaTypeInterface *) {return &Fluent_Icons::staticMetaObject;},
            "Fluent_Icons");
        QMetaType(&metaType).id();
    }
    qmlRegisterNamespaceAndRevisions(&Fluent_Icons::staticMetaObject, "FluentUI", 1, nullptr, &Fluent_Icons::staticMetaObject, nullptr);
