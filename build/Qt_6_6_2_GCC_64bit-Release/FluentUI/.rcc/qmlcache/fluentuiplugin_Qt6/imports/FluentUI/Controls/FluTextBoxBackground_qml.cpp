...
0x50,0x17,0x0,0x0,0x31,0x64,0x36,0x35,
...
0x0,0x0,0x0,0x0,0xa2,0x5d,0x7d,0x2d,
0xec,0xd3,0x95,0x50,0x62,0xc1,0x21,0x25,
0x2f,0xd5,0xec,0x27,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
while (!aotContext->getObjectLookup(52, r2_0, r2_2.data())) {
aotContext->setInstructionPointer(11);
aotContext->initGetObjectLookup(52, r2_0, r2_2.metaType());
if (aotContext->engine->hasError())
    return QVariant();
r2_2 = QVariant(aotContext->lookupResultMetaType(52));
}
...
r2_3 = double(255);
// generate_Div
r2_3 = (std::move(r14_0) / std::move(r2_3));
// generate_StoreReg
r10_0 = std::move(r2_3);
// generate_MoveConst
r14_0 = double(123);
...
label_1:;
// generate_LoadQmlContextPropertyLookup
while (!aotContext->loadSingletonLookup(57, &r2_0)) {
