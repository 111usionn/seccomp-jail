...
- [seccomp-jail 项目文档](#seccomp-jail-项目文档)
  ...
  - [原理介绍](#原理介绍)
    - [PTRACE](#ptrace)
      - [ptrace的不同模式和暂停的不同种类](#ptrace的不同模式和暂停的不同种类)
      - [如何分辨不同种类的暂停](#如何分辨不同种类的暂停)
    - [SECCOMP](#seccomp)
      - [strict](#strict)
      - [bpf](#bpf)
      - [unotify](#unotify)
    ...
    - [软件工作流程](#软件工作流程)
      ...
      - [watcher](#watcher)
      - [软件工作流程总图](#软件工作流程总图)
      - [watcher工作流程图](#watcher工作流程图)
      - [主动执行系统调用流程图](#主动执行系统调用流程图)
      - [注入原理图](#注入原理图)
  - [代码目录索引](#代码目录索引)
  - [使用说明](#使用说明)
    - [环境/依赖](#环境依赖)
    ...
    - [使用流程](#使用流程)
      - [编辑规则](#编辑规则)
        - [永远拒绝(Abort forever)](#永远拒绝abort-forever)
        - [永远允许(Allow forever)](#永远允许allow-forever)
        - [提示(Notify)](#提示notify)
        - [允许(Allow)](#允许allow)
        - [拒绝(Abort)](#拒绝abort)
      - [编辑目标程序路径和参数](#编辑目标程序路径和参数)
      - [监测系统调用](#监测系统调用)
        - [允许](#允许)
        - [拒绝](#拒绝)
        - [允许并添加规则](#允许并添加规则)
